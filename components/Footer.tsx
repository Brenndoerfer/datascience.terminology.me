            ...
            <footer className="">
                <div className="w-100 bg-white border-t min-h-full border-indigo-200 p-4">
                    <div className="max-w-6xl mx-auto py-16 text-md text-gray-500 text-center">
                        <div className="mb-8 w-full md:w-1/2 mx-auto text-justify"><b>Note</b> Explanations are on purpose kept compact and simple. Concepts and terminology are simplified to make them more accesible to different backgrounds. If you wish tou propose changes, please raise a PR on Github.</div>
